  ...
  return (
    <div className={`app-container ${timeTheme}`}>
      ...
      <div className="background-layer">
         ...
         {/* --- ZONA DO CÉU E CENÁRIO (ESTILO KURZGESAGT) --- */}
                  <div className="waves">
                     {/* Camada do Fundo (Montanha distante) */}
                     <svg className="wave-layer-1" viewBox="0 0 1440 320" preserveAspectRatio="none">
                         <path d="M0,160L48,170.7C96,181,192,203,288,213.3C384,224,480,224,576,202.7C672,181,768,139,864,138.7C960,139,1056,181,1152,197.3C1248,213,1344,203,1392,197.3L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
                     </svg>
                     {/* Camada do Meio (Colina) */}
                     <svg className="wave-layer-2" viewBox="0 0 1440 320" preserveAspectRatio="none">
                      ...
                      {/* Camada da Frente (Chão próximo) */}
                     <svg className="wave-layer-3" viewBox="0 0 1440 320" preserveAspectRatio="none">
                         <path d="M0,256L60,245.3C120,235,240,213,360,218.7C480,224,600,256,720,266.7C840,277,960,267,1080,245.3C1200,224,1320,192,1380,176L1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
                     </svg>
                  </div>
